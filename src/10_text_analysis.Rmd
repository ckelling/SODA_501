...
locationNames <- c("ann", "arbor", "michigan", "gainesville", "florida", "college", "station", "texas", "champaign", "illinois", "state", "pennsylvania", "blacksburg", "virginia", "#champaign")

for (i in locationNames) {
  frequency <- subset(frequency, word!=i)
}

topFrequency <- slice(frequency, 1:10)
xtable(topFrequency)
...
topFrequency1 <- rbind(topFrequency1, topFrequency2)
}
