...
#setwd("~/Desktop/paper/SODA501") 
setwd("C:/Users/ckell/OneDrive/Penn State/2017-2018/01_Spring/SODA_501/SODA_501/project/data")
...
towns<-c("Ithaca, NY", "State College, PA", "Bloomington, IN", "Lawrence, KS", "Blacksburg, VA", "College Station, TX", "Columbia, MO", "Champaign, IL", "Ann Arbor, MI", "Gainesville, FL")
...
tweets_sample.selected<-tweets_sample.df[grep(paste(towns,collapse="|"), tweets_sample.df$place$full_name),]
